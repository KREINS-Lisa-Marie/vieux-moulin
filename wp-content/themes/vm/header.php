    ...
    <nav class="nav__header" itemscope itemtype="https://schema.org/Organization">
        ...
        <ul class="nav__container__header__bottom">
            <?php foreach (dw_get_navigation_links('header_bottom') as $link): ?>
                <li class="nav__item__header__bottom">
                    <a href="<?= $link->href; ?>" class="nav__link__header__bottom" aria-label="Aller vers la page <?=$link->label;?>" title="Aller vers la page <?=$link->label;?>"><?= $link->label;?></a>
                </li>
            <?php endforeach; ?>
        </ul>
        ...
        <ul class="nav__container__header__top">
            ...
            <?php foreach (dw_get_navigation_links('header_top') as $link): ?>
                <li class="nav__item__header_top">
                    <a href="<?= $link->href; ?>" class="nav__link__header_top" aria-label="Aller vers la page <?=$link->label;?>" title="Aller vers la page <?=$link->label;?>"><?= $link->label;?></a>
                </li>
            <?php endforeach; ?>
            ...
            <li class="facebook_container">
                <a href="https://www.facebook.com/people/Vieux-Moulin-Strainchamps/pfbid02bLExiMxPRDfak3ahy8h4cWBsRDihrcjNnGQBLHZqehkmfYg2jRzii8zYCWe1n95hl/" title="Aller vers la page Facebook du Vieux Moulin" class="facebook_link" aria-label="Aller vers la page Facebook du Vieux Moulin">
