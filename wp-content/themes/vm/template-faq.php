...
if(have_posts()): while(have_posts()): the_post(); ?>
    ...
    <section class="family_section_container">
        ...
        <a href="<?= get_field('link_faq_to_page'); ?>" title="Aller vers la page 'La vie au foyer'" class="link_to_page link title_middle">Comment se passe la vie chez nous?         <svg width="13" height="8" viewBox="0 0 13 8" fill="none" xmlns="http://www.w3.org/2000/svg" class="arrow">
